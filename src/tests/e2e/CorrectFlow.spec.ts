...
const responseObj: any = {
  accessToken:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Impvc2VkYW5pZWxwYXJyYTA1QG91dGxvb2suY29tIiwiaWF0IjoxNjQ2ODM0ODYzLCJleHAiOjE2NDY4Mzg0NjMsInN1YiI6IjEifQ.asR4IVzWQsoH_P09cRbncKEL9E66NocKMHwNJDnCY_s",
  user: {
...
const vehicleTypes: any = ["Car", "Motorbike"];
